...
import ThirdSubCategoryModal from "./ThirdSubCategoryModal";
import { useAllThirdSubCategoryQuery, useDeleteThirdSubCategoryMutation } from "../../../../../services/ThirdSubCategoryApi";


const ThirdSubCategoryList = () => {
  const res = useAllThirdSubCategoryQuery();
  ...
  const handelDelete = async (id) => {
    const result = await deleteThirdSubCategory(id).unwrap();
  ...
  const columns = useMemo(
    () => [
      ...
      {
        accessorKey: "catagory.name", //access nested data with dot notation
  ...
  return (
    <>
      ...
      <ThirdSubCategoryModal
        ...
        paramId={paramId}
      />
      <PageTopHeader title="Third Category List" />
      <div class="card border shadow-lg ">
        <div class="card-header d-flex justify-content-between ">
          <div>Third Category List </div>
          <div>
            <button
                ...
                >
                  ...
                  <div className="mx-2">
                    <button
                      ...
                      onClick={() => {
                        handleShow();
                        handelClickValue("Edit Category");
                        setParamId(row?.row?.original);
                      }}
                    >
                      <div>
...
export default ThirdSubCategoryList;
