...
import { useUpdateSubCatagoryMutation } from "../../../../../services/subCategoryApi";

const EditSubCategory = ({ handleClose, param }) => {

 

  const [updateSubCatagory, res] = useUpdateSubCatagoryMutation();
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { resetForm }) => {
      ...
      try {
        const result = await updateSubCatagory({ id: param?.id , data: formData }).unwrap();
